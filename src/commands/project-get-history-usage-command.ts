...
export class ProjectGetHistoryUsageCommand extends Command {
    constructor() {
        super('project.getHistoryUsage', { description: 'Get the number of currently stored history data values of a project on the Kolibri Broker' });
