...
export class NodeGetHistoryCommand extends Command {
    constructor() {
        super('node.getHistory', { description: 'Get all values from the point state history from the Kolibri Broker' });
