...
export class UserGroupAddMemberCommand extends Command {
    constructor() {
        super('usergroup.addMember', { description: 'Adds user to a user group in a project on the Kolibri Broker' });
