...
export class UserGroupRemoveMemberCommand extends Command {
    constructor() {
        super('usergroup.removeMember', { description: 'Removes user from a user group in a project on the Kolibri Broker' });
