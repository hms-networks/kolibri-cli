...
export class UserGroupIsMemberCommand extends Command {
    constructor() {
        super('usergroup.isMember', { description: 'Checks if a user is member of a user group on the Kolibri Broker' });
