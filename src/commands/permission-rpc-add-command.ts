...
export class PermissionRpcAddCommand extends Command {
    constructor() {
        super('permission.rpc.add', { description: 'Add RPC permissions for the specified user on the Kolibri Broker' });
